...
\def\affa{Humboldt-Universität zu Berlin} % First Author's Affiliation
...
\institute{Institute for Statistics and Econometrics \\ Chair of Econometrics \\ Humboldt-Universität zu Berlin}
...
\frame{
\frametitle{The East German labour market is interesting for various reasons:}
\begin{itemize}
	\item Changes in wage structure when transitioning from planned to market economy a hot topic in economic research.
	\item Unique chance to check the theory on wage setting regimes.
	\item East German economy / labour market unique in the abruptness of regulatory changes and the existence of a reference labour market.
	\item With the GSOEP and other studies there are especially rich datasets for the German case.
\end{itemize}
}
\frame{
...
\input{/Users/Christian/Statistik_Studium/EconProject/Code/Tex/Tables/WestModelsTotalPresentation.tex}
\end{frame}
\begin{frame}
\frametitle{Coefficients}
\input{/Users/Christian/Statistik_Studium/EconProject/Code/Tex/Tables/EastModelsTotalPresentation.tex}
\end{frame}
\begin{frame}
\frametitle{Coefficients}
\input{/Users/Christian/Statistik_Studium/EconProject/Code/Tex/Tables/WestModelsNewOldPresentation.tex}
\end{frame}
\begin{frame}
\frametitle{Coefficients}
\input{/Users/Christian/Statistik_Studium/EconProject/Code/Tex/Tables/EastModelsNewOldPresentation.tex}
\end{frame}
...
\begin{itemize}
	\item https://github.com/ckoopmann/EconProject
\end{itemize}
}
\end{document}
